...
private:
    ...
    ros::Publisher tree_pub_, plan_pub_, nav_pub_, path_pub_;


    ros::Publisher chosen_point_pub, tree_node_point_pub_, free_point_pub_;
    visualization_msgs::Marker chosen_point;
    visualization_msgs::Marker tree_node_point;
    visualization_msgs::Marker free_point;
    visualization_msgs::Marker whole_path;
